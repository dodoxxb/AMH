...
#                     if samples.shape[0] <= sample_rate * second:
...
if __name__ == "__main__":
    audio_denoise(AUDIO_RAW_PATH["healthy"], AUDIO_DENOISED_PATH["healthy"])
    audio_denoise(AUDIO_RAW_PATH["unhealthy"], AUDIO_DENOISED_PATH["unhealthy"])
